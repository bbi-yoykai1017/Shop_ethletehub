            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="navbar-right d-flex align-items-center">
                    ...
                    <div class="user-action-dropdown dropdown ms-3">
                        <a href="#" class="user-icon-link text-decoration-none dropdown-toggle" id="userMenu"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenu">
                            <?php if (isset($_SESSION['user_name'])): ?>
                                <li>
                                    <h6 class="dropdown-header"><?= htmlspecialchars($_SESSION['user_name']) ?></h6>
                                </li>
                            ...
                            <?php else: ?>
                                <li><a class="dropdown-item" href="login.php"><i class="fas fa-sign-in-alt me-2"></i>Đăng
                                        nhập</a></li>
                                <li><a class="dropdown-item" href="register.php"><i class="fas fa-user-plus me-2"></i>Đăng
                                        ký</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    ...
                    <div class="cart-items-container">
                        ...
                        <?php else: ?>
                            <div id="cartItemsList">
                                <!-- Items will be loaded by JavaScript (loadCart) -->
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="cart-summary" id="cartSummaryBox" <?= $isEmpty ? 'style="display:none"' : '' ?>>
                        ...
                        <div class="summary-item">
                            ...
                            <span id="shippingDisplay"
                                class="<?= $summary['shippingFee'] == 0 ? 'shipping-fee' : '' ?>">
                        ...
                        <div class="order-benefits">
                            <div class="benefit-item"><i class="fas fa-truck"></i><span>Miễn phí ship trên
                                    500.000₫</span></div>
                            <div class="benefit-item"><i class="fas fa-shield-alt"></i><span>Bảo mật thanh toán
                                    100%</span></div>
                            <div class="benefit-item"><i class="fas fa-undo"></i><span>Hoàn hàng trong 30 ngày</span>
                            </div>
                        </div>
                    </div>
                </div>
